...
import org.ontologyengineering.conceptdiagrams.web.server.abstractsyntax.AbstractDiagram;
...
public abstract class Transformation <T extends AbstractDiagram> {
    ...
    public abstract void translate(T transformedDiagram, OWLOutputBuilder outputter);
