...
public class Spider extends DiagramArrowSourceOrTarget<ConcreteSpider> {
    ...
    private HashSet<Zone> eta;
    private HashSet<Spider> equalSpiders;   // shared by all spiders in this equivalence
    ...
    public void setTau(HashSet<Spider> newReation) {
    ...
    public void joinTau(Spider other) {
        ...
        HashSet<Spider> result = new HashSet<Spider>(tau());
