 ...
 */
public interface SaveDiagramServiceAsync {

    void saveCommandHistory(HashSet<ArrayList<Command>> histories, HashMap<String, DiagramSet> diagrams, ClientContext context, AsyncCallback<String> callback);
